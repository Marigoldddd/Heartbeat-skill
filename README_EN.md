...
### 1. Claude Semantic Inference (Core Weight: 60%)
Deep participation by the Claude model to holistically understand the real context:
- Identifying true emotions behind subtext (e.g., differentiating flirty remarks from dismissive ones)
- Pinpointing key relationship events and intense emotional turning points
- Automatically downgrading confidence on highly inactive days, allowing the rule engine to take over

### 2. Objective Behavioral Rules (Objective Weight: 40%)
